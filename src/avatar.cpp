...
ofstream e_mpc_time_graph11("/home/econom2-20/data/e_mpc_time_graph11.txt");
ofstream e_mpc_time_graph12("/home/econom2-20/data/e_mpc_time_graph12.txt");
    ...
    else if (rd_.tc_.mode == 11)
    {
        ...
        if (walking_enable_ == true)
        {
            if (walking_tick_ == 0)
            {
                ...
                torque_desired_prev_container_.setZero();
        ...
        q_desired_virtual_.segment(3,3)   = DyrosMath::rot2Euler(pelv_trajectory_float_.linear());
        ...
        if(atb_walking_traj_update_ == false)
        {
            ...
            qddot_desired_virtual_container_ = qddot_desired_virtual_;
            contact_wrench_container_ = contact_wrench_;

            torque_desired_prev_container_ = torque_desired_prev_;

            is_lfoot_support_container_ = is_lfoot_support_;
            is_rfoot_support_container_ = is_rfoot_support_;

            is_ssp_container_ = is_ssp_;
            is_dsp_container_ = is_dsp_;
        ...
        if(atb_desired_torque_update_ == false)
        {
            ...
            torque_wbd_ = torque_wbd_container_;
            atb_desired_torque_update_ = false;
        }
...
void AvatarController::computeFast()
{
    ...
    else if (rd_.tc_.mode == 11)
    {
        ...
        if(atb_walking_traj_update_ == false)
        {
            ...
            qddot_desired_virtual_fast_ = qddot_desired_virtual_container_;
            contact_wrench_fast_ = contact_wrench_container_;

            torque_desired_prev_fast_ = torque_desired_prev_container_;

            is_lfoot_support_fast_ = is_lfoot_support_container_;
            is_rfoot_support_fast_ = is_rfoot_support_container_;

            is_ssp_fast_ = is_ssp_container_;
            is_dsp_fast_ = is_dsp_container_;
        ...
        if (atb_desired_torque_update_ == false)
        {
            ...
            torque_wbd_container_ = torque_wbd_fast_;
...
{   
    ...
    if(atb_main_to_mpc_update_ == false)
    {
        ...
        ref_com_z_mpc_                      = ref_com_z_container_to_mpc_;

        ref_lzmp_mpc_                       = ref_lzmp_container_to_mpc_;
        ref_rzmp_mpc_                       = ref_rzmp_container_to_mpc_;
    ...
    if(atb_mpc_to_main_update_ == false)
    {
        ...
        MPC_Planner_u_container_from_mpc_                  = MPC_SQ_Planner_u_mpc_;

        current_step_num_container_from_mpc_               = current_step_num_mpc_;

        MPC_Planner_alpha_container_from_mpc_              = MPC_Planner_alpha_mpc_;

        MPC_Planner_lzmp_container_from_mpc_               = MPC_Planner_lzmp_mpc_;

        MPC_Planner_rzmp_container_from_mpc_               = MPC_Planner_rzmp_mpc_;
...
void AvatarController::econom2_thread_stepchange()
{
    ...
    if((current_step_num_mpc_ == 2) && (walking_tick_mpc_ > t_start_mpc_ + 0.7*t_total_))
    {
        del_F_mpc(1) = - 0.1;
    }
...
void AvatarController::getRobotState()
{
    ...
    Y_angle = pelv_rpy_current_mj_(2);
    pelv_yaw_rot_current_from_global_mj_ = DyrosMath::rotateWithZ(pelv_rpy_current_mj_(2));
    ...
    pelv_float_current_dot_.head(3) = DyrosMath::multiplyIsometry3dVector3d(DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_), rd_.link_[Pelvis].v);
    pelv_float_current_dot_.tail(3) = DyrosMath::multiplyIsometry3dVector3d(DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_), rd_.link_[Pelvis].w);
    ...
    lhand_float_current_.linear() = DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_) * rd_.link_[Left_Hand].rotm;
    lhand_float_current_.translation() = DyrosMath::multiplyIsometry3dVector3d(DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_), rd_.link_[Left_Hand].xpos); 

    rhand_float_current_.linear() = DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_) * rd_.link_[Right_Hand].rotm; 
    rhand_float_current_.translation() = DyrosMath::multiplyIsometry3dVector3d(DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_), rd_.link_[Right_Hand].xpos); 
    
    chest_float_current_.linear() = DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_) * rd_.link_[Upper_Body].rotm;  
    chest_float_current_.translation() = DyrosMath::multiplyIsometry3dVector3d(DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_), rd_.link_[Upper_Body].xpos);
    ...
    lfoot_float_current_dot_.segment(0, 3) = DyrosMath::multiplyIsometry3dVector3d(DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_), rd_.link_[Left_Foot].v);
    lfoot_float_current_dot_.segment(3, 3) = DyrosMath::multiplyIsometry3dVector3d(DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_), rd_.link_[Left_Foot].w);
    rfoot_float_current_dot_.segment(0, 3) = DyrosMath::multiplyIsometry3dVector3d(DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_), rd_.link_[Right_Foot].v);
    rfoot_float_current_dot_.segment(3, 3) = DyrosMath::multiplyIsometry3dVector3d(DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_), rd_.link_[Right_Foot].w);

    lhand_float_current_dot_.segment(0, 3) = DyrosMath::multiplyIsometry3dVector3d(DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_), rd_.link_[Left_Hand].v);
    lhand_float_current_dot_.segment(3, 3) = DyrosMath::multiplyIsometry3dVector3d(DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_), rd_.link_[Left_Hand].w);
    rhand_float_current_dot_.segment(0, 3) = DyrosMath::multiplyIsometry3dVector3d(DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_), rd_.link_[Right_Hand].v);
    rhand_float_current_dot_.segment(3, 3) = DyrosMath::multiplyIsometry3dVector3d(DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_), rd_.link_[Right_Hand].w);
    chest_float_current_dot_.segment(0, 3) = DyrosMath::multiplyIsometry3dVector3d(DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_), rd_.link_[Upper_Body].v);
    chest_float_current_dot_.segment(3, 3) = DyrosMath::multiplyIsometry3dVector3d(DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_mj_), rd_.link_[Upper_Body].w);
    ...
    lhand_support_current_ = DyrosMath::inverseIsometry3d(supportfoot_float_current_yaw_only) * lhand_float_current_;
    rhand_support_current_ = DyrosMath::inverseIsometry3d(supportfoot_float_current_yaw_only) * rhand_float_current_;
    chest_support_current_ = DyrosMath::inverseIsometry3d(supportfoot_float_current_yaw_only) * chest_float_current_;

    lhand_trajectory_support_ = DyrosMath::inverseIsometry3d(supportfoot_float_current_yaw_only) * lhand_trajectory_float_;
    rhand_trajectory_support_ = DyrosMath::inverseIsometry3d(supportfoot_float_current_yaw_only) * rhand_trajectory_float_;
    chest_trajectory_support_ = DyrosMath::inverseIsometry3d(supportfoot_float_current_yaw_only) * chest_trajectory_float_;
...
void AvatarController::getZmpTrajectory()
{
    ...
    { planning_zmp_size = t_total_const_ * (total_step_num_ - current_step_num_) + 4.0 * hz_; }
    else
    { planning_zmp_size = t_total_const_ * planning_step_number + 1.0 * hz_; }
    ...
    zmpGenerator_wComZ_e(planning_zmp_size, planning_step_number);
    foot_step_support_frame_.           block(            current_step_num_, 0, 1, 2) -= del_F_.transpose(); 
    foot_step_support_frame_offset_.    block(            current_step_num_, 0, 1, 2) -= del_F_.transpose();
    if(walking_tick_ - t_start_ < t_double1_ + t_rest_init_)
    {
    ...
    ref_lzmp_mpc_.         resize(planning_zmp_size, 2);
    ref_rzmp_mpc_.         resize(planning_zmp_size, 2);

    ref_com_z_mpc_.        resize(planning_zmp_size, 1);
}

void AvatarController::zmpGenerator_wComZ_e(const unsigned int norm_size, const unsigned planning_step_num)
{
    ref_zmp_.setZero(norm_size, 2);
    ref_com_z_.setZero(norm_size, 1);
    ref_zmp_wo_offset_.setZero(norm_size, 2);

    ref_lzmp_.setZero(norm_size, 2);
    ref_rzmp_.setZero(norm_size, 2);

    Eigen::VectorXd temp_px,           temp_py;
    Eigen::VectorXd temp_px_wo_offset, temp_py_wo_offset;
    Eigen::VectorXd temp_cz;
    Eigen::VectorXd temp_lpx,          temp_lpy;
    Eigen::VectorXd temp_rpx,          temp_rpy;
    ...
    if (current_step_num_ == 0)  
    {
        ...
        ref_com_z_.        block(0, 0, 1.0*hz_, 1).setConstant(zc_mj_);
        ...
        ref_com_z_.block(2.0*hz_, 0, t_temp_ - 2.0*hz_, 1).setConstant(zc_mj_);
        ...
        ref_lzmp_.         block(0, 0, t_temp_, 1).setConstant(com_support_init_(0));
        ref_lzmp_.         block(0, 1, t_temp_, 1).setConstant(0.0);

        ref_rzmp_.         block(0, 0, t_temp_, 1).setConstant(com_support_init_(0));
        ref_rzmp_.         block(0, 1, t_temp_, 1).setConstant(2*com_support_init_(1));
    ...
    {   
        ...
        {   
            ...
            onestepComZ         (i, t_total_zmp, temp_cz);
            onestepZmp_LR       (i, t_total_zmp, temp_lpx, temp_rpx, temp_lpy,          temp_rpy);
            ...
            ref_com_z_.        block(index, 0, t_total_zmp, 1) = temp_cz.          block(0, 0, t_total_zmp, 1);
            ...
            ref_lzmp_.         block(index, 0, t_total_zmp, 1) = temp_lpx.         block(0, 0, t_total_zmp, 1);
            ref_lzmp_.         block(index, 1, t_total_zmp, 1) = temp_lpy.         block(0, 0, t_total_zmp, 1);

            ref_rzmp_.         block(index, 0, t_total_zmp, 1) = temp_rpx.         block(0, 0, t_total_zmp, 1);
            ref_rzmp_.         block(index, 1, t_total_zmp, 1) = temp_rpy.         block(0, 0, t_total_zmp, 1);
        ...
        ref_com_z_.        block(index, 0, 3.0 * hz_, 1).setConstant(ref_com_z_        (index - 1, 0));
        ...
        ref_lzmp_.         block(index, 0, 3.0 * hz_, 1).setConstant(ref_lzmp_         (index - 1, 0));
        ref_lzmp_.         block(index, 1, 3.0 * hz_, 1).setConstant(ref_lzmp_         (index - 1, 1));

        ref_rzmp_.         block(index, 0, 3.0 * hz_, 1).setConstant(ref_rzmp_         (index - 1, 0));
        ref_rzmp_.         block(index, 1, 3.0 * hz_, 1).setConstant(ref_rzmp_         (index - 1, 1));
...
void AvatarController::onestepZmp_wo_offset(unsigned int current_step_number, double t_total_zmp, Eigen::VectorXd &temp_px, Eigen::VectorXd &temp_py, Eigen::VectorXd &temp_px_wo_offset, Eigen::VectorXd &temp_py_wo_offset)
{
    ...
    double Kx_step           = 0, Ky_step           = 0, A_step             = 0, B_step             = 0, wn_step = 0, Kx2_step = 0, Ky2_step = 0;
    double Kx_wo_offset      = 0, Ky_wo_offset      = 0, Kx2_wo_offset      = 0, Ky2_wo_offset      = 0;
    double Kx_wo_offset_step = 0, Ky_wo_offset_step = 0, Kx2_wo_offset_step = 0, Ky2_wo_offset_step = 0;
    ...
    {   
        ...
        {   
            ...
            Ky2_step = (m_del_zmp_y(current_step_number, prev_stepping_flag) + foot_step_support_frame_offset_(current_step_number, 1) + foot_step_support_frame_offset_(current_step_number - 1, 1))*(t_rest_last_ + t_double2_)/(t_rest_init_ + t_double1_ + t_rest_last_ + t_double2_) - foot_step_support_frame_offset_(current_step_number - 1, 1);
            ...
            Ky2_wo_offset_step = (m_del_zmp_y(current_step_number, prev_stepping_flag) + foot_step_support_frame_(current_step_number, 1) + foot_step_support_frame_(current_step_number - 1, 1))*(t_rest_last_ + t_double2_)/(t_rest_init_ + t_double1_ + t_rest_last_ + t_double2_) - foot_step_support_frame_(current_step_number - 1, 1);
            ...
            for (int i = 0; i < t_total_zmp; i++)
            {
                ...
                else if (i >= t_total_zmp - t_rest_last_ - t_double2_ && i < t_total_zmp)  
                {
                    ...
                    {
                        temp_py(i) = foot_step_support_frame_offset_(current_step_number - 1, 1) + Ky2_step/(t_double2_ + t_rest_last_) * (i+1 -(t_total_zmp - t_rest_last_ - t_double2_));
                        temp_py_wo_offset(i) = foot_step_support_frame_(current_step_number - 1, 1) + Ky2_wo_offset_step/(t_double2_ + t_rest_last_) * (i + 1 - (t_total_zmp - t_rest_last_ - t_double2_));    
                    }
                    else
                    {
                        temp_py(i) = foot_step_support_frame_offset_(current_step_number - 1, 1) + Ky2/(t_double2_ + t_rest_last_) * (i+1 -(t_total_zmp - t_rest_last_ - t_double2_));
        ...
        else if(first_current_step_flag_ == 1)
        {
            Kx = foot_step_support_frame_offset_(current_step_number - 1, 0) - ((foot_step_support_frame_offset_(current_step_number - 2, 0) + foot_step_support_frame_offset_(current_step_number - 1, 0)) / 2);
            Ky = foot_step_support_frame_offset_(current_step_number - 1, 1) - ((foot_step_support_frame_offset_(current_step_number - 2, 1) + foot_step_support_frame_offset_(current_step_number - 1, 1)) / 2);
            Ky_step = foot_step_support_frame_offset_(current_step_number - 1, 1) - ((foot_step_support_frame_offset_(current_step_number - 2, 1) + foot_step_support_frame_offset_(current_step_number - 1, 1))*(t_rest_init_ + t_double2_)/(t_rest_init_ + t_double1_ + t_rest_last_ + t_double2_));
            Kx2 = (foot_step_support_frame_offset_(current_step_number, 0) + foot_step_support_frame_offset_(current_step_number - 1, 0)) / 2 - foot_step_support_frame_offset_(current_step_number - 1, 0);
            Ky2 = (foot_step_support_frame_offset_(current_step_number, 1) + foot_step_support_frame_offset_(current_step_number - 1, 1)) / 2 - foot_step_support_frame_offset_(current_step_number - 1, 1);

            Kx_wo_offset = foot_step_support_frame_(current_step_number - 1, 0) - ((foot_step_support_frame_(current_step_number - 2, 0) + foot_step_support_frame_(current_step_number - 1, 0)) / 2);
            Ky_wo_offset = foot_step_support_frame_(current_step_number - 1, 1) - ((foot_step_support_frame_(current_step_number - 2, 1) + foot_step_support_frame_(current_step_number - 1, 1)) / 2);
            Ky_wo_offset_step = foot_step_support_frame_(current_step_number - 1, 1) - ((foot_step_support_frame_(current_step_number - 2, 1) + foot_step_support_frame_(current_step_number - 1, 1))*(t_rest_init_ + t_double2_)/(t_rest_init_ + t_double1_ + t_rest_last_ + t_double2_));
            Kx2_wo_offset = (foot_step_support_frame_(current_step_number, 0) + foot_step_support_frame_(current_step_number - 1, 0)) / 2 - foot_step_support_frame_(current_step_number - 1, 0);
            Ky2_wo_offset = (foot_step_support_frame_(current_step_number, 1) + foot_step_support_frame_(current_step_number - 1, 1)) / 2 - foot_step_support_frame_(current_step_number - 1, 1);
            ...
            {   
                ...
                {   
                    if(first_current_step_number_ + 1 == current_step_number)
                    {
                        ...
                        temp_py(i) = m_del_zmp_y(first_current_step_number_, prev_stepping_flag)*(t_rest_last_ + t_double2_)/(t_rest_init_ + t_double1_ + t_rest_last_ + t_double2_)
                                  + (foot_step_support_frame_offset_(current_step_number - 2, 1) + foot_step_support_frame_offset_(current_step_number - 1, 1))*(t_rest_init_ + t_double2_)/(t_rest_init_ + t_double1_ + t_rest_last_ + t_double2_)
                                  + (Ky_step + m_del_zmp_y(first_current_step_number_, prev_stepping_flag)*(t_rest_last_ + t_double1_)/(t_rest_init_ + t_double1_ + t_rest_last_ + t_double2_)) / (t_rest_init_ + t_double1_)*(i+1);
                        ...
                        temp_py_wo_offset(i) = m_del_zmp_y(first_current_step_number_, prev_stepping_flag)*(t_rest_last_ + t_double2_)/(t_rest_init_ + t_double1_ + t_rest_last_ + t_double2_)
                                            + (foot_step_support_frame_(current_step_number - 2, 1) + foot_step_support_frame_(current_step_number - 1, 1))*(t_rest_init_ + t_double2_)/(t_rest_init_ + t_double1_ + t_rest_last_ + t_double2_)
                                            + (Ky_wo_offset_step + m_del_zmp_y(first_current_step_number_, prev_stepping_flag)*(t_rest_last_ + t_double1_)/(t_rest_init_ + t_double1_ + t_rest_last_ + t_double2_)) / (t_rest_init_ + t_double1_)*(i+1);
                    }
                    else
                    {
...
void AvatarController::onestepZmp_LR(unsigned int current_step_number, double t_total_zmp, Eigen::VectorXd& temp_lpx, Eigen::VectorXd& temp_rpx, Eigen::VectorXd& temp_lpy, Eigen::VectorXd& temp_rpy)
{
    temp_lpx.setZero(t_total_zmp); temp_lpy.setZero(t_total_zmp);
    temp_rpx.setZero(t_total_zmp); temp_rpy.setZero(t_total_zmp);

    int current_step_num_int_calc = current_step_number;
    if(foot_step_(current_step_number, 6) == 0) //rfoot support
    {
        temp_lpx.segment(0.0*t_total_zmp, 0.5*t_total_zmp).setConstant(foot_step_support_frame_(max(              0, current_step_num_int_calc - 2), 0));
        temp_lpx.segment(0.5*t_total_zmp, 0.5*t_total_zmp).setConstant(foot_step_support_frame_(min(total_step_num_, current_step_num_int_calc + 0), 0));
        temp_rpx.segment(0.0*t_total_zmp, 1.0*t_total_zmp).setConstant(foot_step_support_frame_(max(              0, current_step_num_int_calc - 1), 0));

        temp_lpy.segment(0.0*t_total_zmp, 0.5*t_total_zmp).setConstant(foot_step_support_frame_(max(              0, current_step_num_int_calc - 2), 1));
        temp_lpy.segment(0.5*t_total_zmp, 0.5*t_total_zmp).setConstant(foot_step_support_frame_(min(total_step_num_, current_step_num_int_calc + 0), 1));
        temp_rpy.segment(0.0*t_total_zmp, 1.0*t_total_zmp).setConstant(foot_step_support_frame_(max(              0, current_step_num_int_calc - 1), 1));
    }
    else
    {
        temp_lpx.segment(0.0*t_total_zmp, 1.0*t_total_zmp).setConstant(foot_step_support_frame_(max(              0, current_step_num_int_calc - 1), 0));
        temp_rpx.segment(0.0*t_total_zmp, 0.5*t_total_zmp).setConstant(foot_step_support_frame_(max(              0, current_step_num_int_calc - 2), 0));
        temp_rpx.segment(0.5*t_total_zmp, 0.5*t_total_zmp).setConstant(foot_step_support_frame_(min(total_step_num_, current_step_num_int_calc + 0), 0));

        temp_lpy.segment(0.0*t_total_zmp, 1.0*t_total_zmp).setConstant(foot_step_support_frame_(max(              0, current_step_num_int_calc - 1), 1));
        temp_rpy.segment(0.0*t_total_zmp, 0.5*t_total_zmp).setConstant(foot_step_support_frame_(max(              0, current_step_num_int_calc - 2), 1));
        temp_rpy.segment(0.5*t_total_zmp, 0.5*t_total_zmp).setConstant(foot_step_support_frame_(min(total_step_num_, current_step_num_int_calc + 0), 1));
    }

    if(current_step_number == 0)
    {
        temp_lpy.setZero();
        temp_rpy.segment(0.0*t_total_zmp, 0.5*t_total_zmp).setConstant(2*com_support_init_(1));
    }

    if(current_step_number == 1)
    {
        temp_lpy.segment(0.0*t_total_zmp, 0.5*t_total_zmp).setConstant(supportfoot_support_init_(1));
        temp_lpy.segment(0.5*t_total_zmp, 0.5*t_total_zmp).setConstant(foot_step_support_frame_(current_step_num_int_calc, 1));
    }
}

void AvatarController::onestepComZ(unsigned int current_step_number, double t_total_zmp, Eigen::VectorXd &temp_cz)
{
    temp_cz.setZero(t_total_zmp);

    double height_diff = 0.0;
    if(current_step_number ==  4) { height_diff = + 0.15; }
    if(current_step_number ==  5) { height_diff = + 0.00; }
    if(current_step_number ==  6) { height_diff = + 0.15; }
    if(current_step_number ==  7) { height_diff = + 0.00; }
    if(current_step_number ==  8) { height_diff = + 0.15; }
    if(current_step_number ==  9) { height_diff = + 0.00; }
    
    foot_step_support_frame_(current_step_number, 2) = height_diff;

    double height_max = sqrt(pow(zc_mj_ + 0.02,2) + pow(0.1,2) - pow(0.5*step_length_x_,2)) - zc_mj_;
    height_diff = DyrosMath::minmax_cut(height_diff, -0.4, height_max);

    temp_cz.setConstant(zc_mj_ + height_diff);
}
    ...
    else if (walking_tick_ >= t_start_ + t_rest_init_ + t_double1_ && walking_tick_ < t_start_ + t_total_ - t_double2_ - t_rest_last_)
    {
        if (foot_step_(current_step_num_, 6) == 1)
        {
            ...
            if (walking_tick_ < t_start_ + t_rest_init_ + t_double1_ + (t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0)
            {
                ...
                rfoot_trajectory_support_.translation()(2) = DyrosMath::cubic(walking_tick_, t_start_ + t_rest_init_ + t_double1_, t_start_real_ + t_double1_ + 0.6*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0, rfoot_support_init_.translation()(2), max(rfoot_support_init_.translation()(2) + foot_height_, target_swing_foot(2) + foot_height_), 0.0, 0.0);
            }
            else
            {
                rfoot_trajectory_support_.translation()(2) = DyrosMath::cubic(walking_tick_, t_start_real_ + t_double1_ + (t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0, t_start_ + t_total_ - t_rest_last_ - t_double2_, max(rfoot_support_init_.translation()(2) + foot_height_, target_swing_foot(2) + foot_height_), target_swing_foot(2), 0.0, 0.0);
            }
        ...
        else if (foot_step_(current_step_num_, 6) == 0)
        {
            ...
            if (walking_tick_ < t_start_ + t_rest_init_ + t_double1_ + (t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0)
            {
                ...
                lfoot_trajectory_support_.translation()(2) = DyrosMath::cubic(walking_tick_, t_start_real_ + t_double1_, t_start_real_ + t_double1_ + 0.6*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0, lfoot_support_init_.translation()(2), max(lfoot_support_init_.translation()(2) + foot_height_, target_swing_foot(2) + foot_height_), 0.0, 0.0);
            }
            else
            {
                lfoot_trajectory_support_.translation()(2) = DyrosMath::cubic(walking_tick_, t_start_real_ + t_double1_ + (t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0, t_start_ + t_total_ - t_rest_last_ - t_double2_, max(lfoot_support_init_.translation()(2) + foot_height_, target_swing_foot(2) + foot_height_), target_swing_foot(2), 0.0, 0.0);
            }
            ...
            lfoot_trajectory_euler_support_(2) = DyrosMath::cubic(walking_tick_, t_start_ + t_rest_init_ + t_double1_, t_start_ + t_total_ - t_rest_last_ - t_double2_, lfoot_support_euler_init_(2), target_swing_foot(5), 0.0, 0.0);
            lfoot_trajectory_support_.linear() = DyrosMath::rotateWithZ(lfoot_trajectory_euler_support_(2)) * DyrosMath::rotateWithY(F_T_L_y_input) * DyrosMath::rotateWithX(-F_T_L_x_input);
        }
    }
    //after swing
...
{   
    ...
    zmp_modif_time_margin_ = 0.15*hz_;

    //if(walking_tick_ == t_start_ + t_total_ - t_double2_ - t_rest_last_ - zmp_modif_time_margin_)
    if(walking_tick_ <= t_start_ + t_total_ - t_double2_ - t_rest_last_ - zmp_modif_time_margin_) // determine experimentally
    {
        fixed_swing_foot(0) = desired_swing_foot(0); 
        fixed_swing_foot(1) = desired_swing_foot(1);

        modified_del_zmp_(current_step_num_,0) = 0.0;//del_F_(0);// - target_swing_foot(0);
        modified_del_zmp_(current_step_num_,1) = 0.0;//del_F_(1);// - target_swing_foot(1);
    }
    ...
    {   
        ...
        if (foot_step_(current_step_num_, 6) == 1)
        {
            ...
            double calc_temp = 1.0;
            if(abs(del_F_(0)) >= 0.15)
            {
                calc_temp = 1.0;
            }
            ...
            //if (walking_tick_ < t_start_ + t_rest_init_ + t_double1_ + 1.0*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0)
            if (walking_tick_ < t_start_ + t_rest_init_ + t_double1_ + calc_temp*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0)
            {
                Eigen::Vector3d temp;
                if(target_swing_foot(2) > 0)
                {
                    temp = DyrosMath::QuinticSpline(walking_tick_, t_start_ + t_rest_init_ + t_double1_, t_start_real_ + t_double1_ + calc_temp*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0, rfoot_support_init_.translation()(2), 0.0, 0.0, rfoot_support_init_.translation()(2) + target_swing_foot(2) + foot_height_, 0.0, 0.0);
                    rfoot_trajectory_support_.translation()(2) = temp(0);
                }
                else if(target_swing_foot(2) == 0)
                {
                    temp = DyrosMath::QuinticSpline(walking_tick_, t_start_ + t_rest_init_ + t_double1_, t_start_real_ + t_double1_ + calc_temp*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0, rfoot_support_init_.translation()(2), 0.0, 0.0, rfoot_support_init_.translation()(2) + target_swing_foot(2) + foot_height_, 0.0, 0.0);
                    rfoot_trajectory_support_.translation()(2) = temp(0);
                }
                ...
                {
                    temp = DyrosMath::QuinticSpline(walking_tick_, t_start_ + t_rest_init_ + t_double1_, t_start_real_ + t_double1_ + calc_temp*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0, rfoot_support_init_.translation()(2), 0.0, 0.0, rfoot_support_init_.translation()(2) + foot_height_, 0.0, 0.0);
                    rfoot_trajectory_support_.translation()(2) = temp(0);
                }
            }
            else
            {
                if(current_step_num_ == 3) { calc_temp = 1.0; }
                Eigen::Vector3d temp;
                if(target_swing_foot(2) > 0)
                {
                    temp = DyrosMath::QuinticSpline(walking_tick_, t_start_real_ + t_double1_ + (2 - calc_temp)*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0, t_start_ + t_total_ - t_rest_last_ - t_double2_, rfoot_support_init_.translation()(2) + target_swing_foot(2) + foot_height_, 0.0, 0.0, target_swing_foot(2), 0.0, 0.0);
                    rfoot_trajectory_support_.translation()(2) = temp(0);
                }
                else if(target_swing_foot(2) == 0)
                {
                ...
                {
                    temp = DyrosMath::QuinticSpline(walking_tick_, t_start_real_ + t_double1_ + (2 - calc_temp)*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0, t_start_ + t_total_ - t_rest_last_ - t_double2_, rfoot_support_init_.translation()(2) + foot_height_, 0.0, 0.0, target_swing_foot(2), 0.0, 0.0);
                    rfoot_trajectory_support_.translation()(2) = temp(0);
                }
            }

            Eigen::Vector3d temp;
            temp = DyrosMath::QuinticSpline(walking_tick_, t_start_real_ + t_double1_ + (1 - calc_temp)*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_)/2.0, t_start_ + t_total_ - t_rest_last_ - t_double2_ - (1 - calc_temp)*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0, rfoot_support_init_.translation()(0), 0.0, 0.0, desired_swing_foot(0), 0.0, 0.0);
            rfoot_trajectory_support_.translation()(0) = temp(0);
            rfoot_trajectory_support_.translation()(1) = DyrosMath::cubic(walking_tick_, t_start_real_ + t_double1_, t_start_ + t_total_ - t_rest_last_ - t_double2_, rfoot_support_init_.translation()(1), desired_swing_foot(1), 0.0, 0.0);    
        ...
        else if (foot_step_(current_step_num_, 6) == 0)
        {
            ...
            //if (walking_tick_ < t_start_ + t_rest_init_ + t_double1_ + 1.2*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0)
            if (walking_tick_ < t_start_ + t_rest_init_ + t_double1_ + calc_temp*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0)
            {
                Eigen::Vector3d temp;
                if(target_swing_foot(2) > 0)
                {
                    temp = DyrosMath::QuinticSpline(walking_tick_, t_start_real_ + t_double1_, t_start_real_ + t_double1_ + calc_temp*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0, lfoot_support_init_.translation()(2), 0.0, 0.0, lfoot_support_init_.translation()(2) + target_swing_foot(2) + foot_height_, 0.0, 0.0);
                ...
                {
                    temp = DyrosMath::QuinticSpline(walking_tick_, t_start_real_ + t_double1_, t_start_real_ + t_double1_ + calc_temp*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0, lfoot_support_init_.translation()(2), 0.0, 0.0, lfoot_support_init_.translation()(2) + foot_height_, 0.0, 0.0);
                    lfoot_trajectory_support_.translation()(2) = temp(0);
                }
            }
            else
            {
                ...
                if(target_swing_foot(2) > 0)
                {
                    temp = DyrosMath::QuinticSpline(walking_tick_, t_start_real_ + t_double1_ + (2 - calc_temp)*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0, t_start_ + t_total_ - t_rest_last_ - t_double2_, lfoot_support_init_.translation()(2) + target_swing_foot(2) + foot_height_, 0.0, 0.0, target_swing_foot(2), 0.0, 0.0);
                    lfoot_trajectory_support_.translation()(2) = temp(0);
                }
                else if(target_swing_foot(2) == 0)
                {
                ...
                {
                    temp = DyrosMath::QuinticSpline(walking_tick_, t_start_real_ + t_double1_ + (2 - calc_temp)*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0, t_start_ + t_total_ - t_rest_last_ - t_double2_, lfoot_support_init_.translation()(2) + foot_height_,0.0, 0.0, target_swing_foot(2), 0.0, 0.0);
                    lfoot_trajectory_support_.translation()(2) = temp(0);
                }
            }

            Eigen::Vector3d temp;
            temp = DyrosMath::QuinticSpline(walking_tick_, t_start_real_ + t_double1_ + (1 - calc_temp)*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_)/2.0, t_start_ + t_total_ - t_rest_last_ - t_double2_ - (1 - calc_temp)*(t_total_ - t_rest_init_ - t_rest_last_ - t_double1_ - t_double2_) / 2.0, lfoot_support_init_.translation()(0), 0.0, 0.0, desired_swing_foot(0), 0.0, 0.0);
            lfoot_trajectory_support_.translation()(0) = temp(0);
            lfoot_trajectory_support_.translation()(1) = DyrosMath::cubic(walking_tick_, t_start_real_ + t_double1_, t_start_ + t_total_ - t_rest_last_ - t_double2_, lfoot_support_init_.translation()(1), desired_swing_foot(1), 0.0, 0.0);    
...
void AvatarController::getPelvTrajectory()
{
    ...
    pelv_trajectory_support_.translation()(1) = pelv_support_current_.translation()(1) + 0.6 * (com_desired_(1) - com_support_current_(1));
...
void AvatarController::supportToFloatPattern()
{
    ...
    if(walking_tick_ >= t_start_ + t_double1_ + t_rest_init_ && walking_tick_ <= t_start_ + t_total_ - t_double2_ - t_rest_last_)
    {
        if(foot_step_(current_step_num_,6) == 1) // left foot support
        {
...
void AvatarController::getComTrajectory_mpc()
{
    if(walking_tick_ == 0)
    {
        ...
        MPC_SQ_Planner_u_mpc_.setZero(3);
    ...
    if(atb_main_to_mpc_update_ == false)
    {
        ...
        ref_com_z_container_to_mpc_                      = ref_com_z_;

        ref_lzmp_container_to_mpc_                       = ref_lzmp_;
        ref_rzmp_container_to_mpc_                       = ref_rzmp_;
    ...
    { 
        if(atb_mpc_to_main_update_ == false)
        {
            ...
            MPC_Planner_u_main_ = MPC_Planner_u_container_from_mpc_;
            ...
            MPC_Planner_alpha_main_              = MPC_Planner_alpha_container_from_mpc_;

            MPC_Planner_lzmp_main_               = MPC_Planner_lzmp_container_from_mpc_;

            MPC_Planner_rzmp_main_               = MPC_Planner_rzmp_container_from_mpc_;
    ...
    Eigen::MatrixXd B_calc;      B_calc.resize(3,1);
    ...
    Planner_state_main_calc_.segment(0,3) = A_calc*Planner_state_main_calc_.segment(0,3) + B_calc*MPC_Planner_u_main_(0);
    Planner_state_main_calc_.segment(3,3) = A_calc*Planner_state_main_calc_.segment(3,3) + B_calc*MPC_Planner_u_main_(1);
    Planner_state_main_calc_.segment(6,3) = A_calc*Planner_state_main_calc_.segment(6,3) + B_calc*MPC_Planner_u_main_(2);
    ...
    del_F_(0) = 0.0;
    del_F_(1) = 0.0;
    if((current_step_num_ == 2) && (walking_tick_ > t_start_ + 0.5*t_total_))
    {
        del_F_(1) = - 0.1;
        del_F_(1) = DyrosMath::cubic(walking_tick_, t_start_ + 0.5*t_total_, t_start_ + t_total_ - t_double2_ - t_rest_last_, 0.0, -0.1, 0.0, 0.0);
    }
    ...
    if(walking_tick_ == t_start_ + t_total_ - 1 && current_step_num_ != total_step_num_ - 1)
    {
        ...
        var_before_step_change(0) = Planner_state_main_calc_(1);
        var_before_step_change(1) = Planner_state_main_calc_(4);
        var_before_step_change(2) = Planner_state_main_calc_(7);
        var_after_step_change = frame_rot_diff*var_before_step_change;
        Planner_state_main_calc_(1) = var_after_step_change(0);
        Planner_state_main_calc_(4) = var_after_step_change(1);
        Planner_state_main_calc_(7) = var_after_step_change(2);
...
void AvatarController::VHIPM_CoM_SQ_Planner_MPC(double mpc_freq, double mpc_dt, double mpc_preview_window, int mpc_synchro_hz)
{
    ...
    wplvy = 1e+1; wprvy = 1e+1;  wdalp = 0e+1;
    ...
    const int dsp_length_mpc_tick = (t_double1_ + t_rest_init_ + t_double2_ + t_rest_last_)/mpc_synchro_hz;

    const int input_num_z  = N_plan_mpc;
    const int input_num_xy = N_plan_mpc + 3*2*dsp_length_mpc_tick;
    ...
    if(MPC_first_loop == 0)
    {
        ...
        Pcas_plan_mpc_.resize(N_plan_mpc,N_state);
        ...
        Pcau_plan_mpc_.setZero(N_plan_mpc,N_plan_mpc);
        ...
        Qxcalc_plan_mpc_.setZero(input_num_xy, input_num_xy);
        Qycalc_plan_mpc_.setZero(input_num_xy, input_num_xy);
        Qzcalc_plan_mpc_.setZero(input_num_z,  input_num_z);
        Qzcalc_plan_mpc_ = Pcpu_plan_mpc_.transpose()*wpvz*Qmat_plan_mpc_*Pcpu_plan_mpc_ + wdvz*Qmat_plan_mpc_;
        
        gxcalc_plan_mpc_.setZero(input_num_xy, N_plan_mpc);
        gycalc_plan_mpc_.setZero(input_num_xy, N_plan_mpc);
        gzcalc_plan_mpc_.setZero(input_num_z,  N_plan_mpc);
        gzcalc_plan_mpc_ = Pcpu_plan_mpc_.transpose()*wpvz*Qmat_plan_mpc_;

        QP_MPC_Planner_X_.InitializeProblemSize(input_num_xy, 4*N_plan_mpc);
        QP_MPC_Planner_Y_.InitializeProblemSize(input_num_xy, 4*N_plan_mpc);
        QP_MPC_Planner_Z_.InitializeProblemSize(input_num_z,  1*N_plan_mpc);

        SUp_plan_mpc_.  setZero(N_plan_mpc, input_num_xy);
        SUpa_plan_mpc_. setZero(2*dsp_length_mpc_tick, input_num_xy);
        SUplp_plan_mpc_.setZero(2*dsp_length_mpc_tick, input_num_xy);
        SUprp_plan_mpc_.setZero(2*dsp_length_mpc_tick, input_num_xy);
        SUp_plan_mpc_.  block(0, 0*N_plan_mpc + 0*dsp_length_mpc_tick, N_plan_mpc,            N_plan_mpc)            = MatrixXd::Identity(N_plan_mpc, N_plan_mpc);
        SUpa_plan_mpc_. block(0, 1*N_plan_mpc + 0*dsp_length_mpc_tick, 2*dsp_length_mpc_tick, 2*dsp_length_mpc_tick) = MatrixXd::Identity(2*dsp_length_mpc_tick, 2*dsp_length_mpc_tick);
        SUplp_plan_mpc_.block(0, 1*N_plan_mpc + 2*dsp_length_mpc_tick, 2*dsp_length_mpc_tick, 2*dsp_length_mpc_tick) = MatrixXd::Identity(2*dsp_length_mpc_tick, 2*dsp_length_mpc_tick);
        SUprp_plan_mpc_.block(0, 1*N_plan_mpc + 4*dsp_length_mpc_tick, 2*dsp_length_mpc_tick, 2*dsp_length_mpc_tick) = MatrixXd::Identity(2*dsp_length_mpc_tick, 2*dsp_length_mpc_tick);

        MPC_Planner_u_mpc_x_.setZero(input_num_xy);
        MPC_Planner_u_mpc_y_.setZero(input_num_xy);
        MPC_Planner_u_mpc_z_.setZero(input_num_z);
        ...
        zmp_min_Lpy_mpc_.setZero(N_plan_mpc);

        zmp_max_Rpy_mpc_.setZero(N_plan_mpc);
        zmp_min_Rpy_mpc_.setZero(N_plan_mpc);
    ...
    Eigen::VectorXd lf_checker(N_plan_mpc);  lf_checker.setZero();
    Eigen::VectorXd rf_checker(N_plan_mpc);  rf_checker.setZero();
    Eigen::VectorXd dsp_checker(N_plan_mpc); dsp_checker.setOnes();
    
    for(int i = 0; i < N_plan_mpc; i++)
    {
        Pv_x_ref(i)         = ref_zmp_mpc_          (mpc_tick + mpc_synchro_hz * (i + 1), 0);
        Pv_y_ref(i)         = ref_zmp_mpc_          (mpc_tick + mpc_synchro_hz * (i + 1), 1);
        Pv_z_ref(i)         = ref_com_z_mpc_        (mpc_tick + mpc_synchro_hz * (i + 1), 0);
        ...
        zmp_max_Lpy_mpc_(i) = ref_lzmp_mpc_         (mpc_tick + mpc_synchro_hz * (i + 1), 1) + zmp_y_max;
        zmp_min_Lpy_mpc_(i) = ref_lzmp_mpc_         (mpc_tick + mpc_synchro_hz * (i + 1), 1) - zmp_y_min;

        zmp_max_Rpy_mpc_(i) = ref_rzmp_mpc_         (mpc_tick + mpc_synchro_hz * (i + 1), 1) + zmp_y_max;
        zmp_min_Rpy_mpc_(i) = ref_rzmp_mpc_         (mpc_tick + mpc_synchro_hz * (i + 1), 1) - zmp_y_min;

        for(int step = 0; step < 3; step++)
        {
            if(mpc_tick + mpc_synchro_hz*(i+1) > t_total_*step + t_double1_ + t_rest_init_)
            {
                if(mpc_tick + mpc_synchro_hz*(i+1) < t_total_*step + t_total_ - t_double2_ - t_rest_last_)
                {
                    if(foot_step_(current_step_num_mpc_ + step, 6) == 0)
                    {
                        lf_checker(i) = 0;
                        rf_checker(i) = 1;
                    }
            ...
            if((mpc_tick + mpc_synchro_hz*(i+1) < t_temp_) && (current_step_num_mpc_ == 0))
            {
                lf_checker(i) = 0.5;
                rf_checker(i) = 0.5;
            }
    ...
    Eigen::MatrixXd dsp_checker_diagonal = dsp_checker.asDiagonal();

    Eigen::MatrixXd dsp_real_selection;
    dsp_real_selection.setZero(1, N_plan_mpc);

    for(int i = 0; i < N_plan_mpc; i++)
    {
        if((1 - dsp_checker_diagonal.row(i).isApprox(MatrixXd::Zero(1, N_plan_mpc))) && (walking_tick_mpc_ > t_temp_ + t_total_))
        {
            if(dsp_real_selection.row(0).isApprox(MatrixXd::Zero(1, N_plan_mpc)))
            {
                dsp_real_selection.row(0) = dsp_checker_diagonal.row(i);
            }
            else
            {
                dsp_real_selection.conservativeResize(dsp_real_selection.rows() + 1, dsp_real_selection.cols());
                dsp_real_selection.row(dsp_real_selection.rows() - 1) = dsp_checker_diagonal.row(i);
            }
        }
    }

    //Z direction
    gcalc_plan_mpc_.setZero(input_num_z, N_plan_mpc);
    ...
    const_A_mpc_.setZero(N_plan_mpc, input_num_z);
    ...
    for(int i = 0; i < N_plan_mpc; i++)
    {
        Cvp_mpc_ << 1, 0, - Planner_State_Prev_mpc_(6,i)/(Planner_State_Prev_mpc_(8,i) + GRAVITY);
    ...
    //X direction
    gcalc_plan_mpc_.setZero(input_num_xy, N_plan_mpc);
    ...
    const_A_mpc_. setZero(4*N_plan_mpc, input_num_xy);
    const_ub_mpc_.setZero(4*N_plan_mpc, 1);
    const_lb_mpc_.setZero(4*N_plan_mpc, 1);

    //zmp const
    const_A_mpc_.block( 0*N_plan_mpc, 0, N_plan_mpc, input_num_xy) = Pvpu_plan_mpc_*SUp_plan_mpc_;
    ...
    const_SQP_Phi_mpc_calc_.setZero(input_num_xy, input_num_xy);
    const_SQP_Pi_mpc_.      setZero(input_num_xy, 1);
    ...
    for(int s = 0; s < sqp_iter; s++)
    {
        ...
        //lzmp rzmp sum
        for(int i = 0; i < dsp_real_selection.rows(); i++)
        {
            ...
            const_A_mpc_.row( 0*N_plan_mpc + i) = (2*const_SQP_Phi_mpc_calc_*MPC_Planner_u_mpc_y_ + const_SQP_Pi_mpc_).transpose();
            const_ub_mpc_.row(0*N_plan_mpc + i) = - const_SQP_hi_mpc_;
            const_lb_mpc_.row(0*N_plan_mpc + i) = - const_SQP_hi_mpc_;
        }

        /*
        //zmp const
        //const_A_mpc_.block( 1*N_plan_mpc, 0, N_plan_mpc, 4*N_plan_mpc) = Pvpu_plan_mpc_*SUp_plan_mpc_;
        //const_ub_mpc_.block(1*N_plan_mpc, 0, N_plan_mpc, 1) = - Pvpu_plan_mpc_*SUp_plan_mpc_*MPC_Planner_u_mpc_y_ + zmp_max_y_mpc_ - Pvps_plan_mpc_*ssy_plan_mpc_*MPC_Planner_state_mpc_;
        //const_lb_mpc_.block(1*N_plan_mpc, 0, N_plan_mpc, 1) = - Pvpu_plan_mpc_*SUp_plan_mpc_*MPC_Planner_u_mpc_y_ + zmp_min_y_mpc_ - Pvps_plan_mpc_*ssy_plan_mpc_*MPC_Planner_state_mpc_;

        const_A_mpc_.block( 1*N_plan_mpc, 0, N_plan_mpc, 4*N_plan_mpc) = SUplp_plan_mpc_;
        const_ub_mpc_.block(1*N_plan_mpc, 0, N_plan_mpc, 1)            = - SUplp_plan_mpc_*MPC_Planner_u_mpc_y_ + zmp_max_Lpy_mpc_;
        const_lb_mpc_.block(1*N_plan_mpc, 0, N_plan_mpc, 1)            = - SUplp_plan_mpc_*MPC_Planner_u_mpc_y_ + zmp_min_Lpy_mpc_;
        const_A_mpc_.block( 2*N_plan_mpc, 0, N_plan_mpc, 4*N_plan_mpc) = SUprp_plan_mpc_;
        const_ub_mpc_.block(2*N_plan_mpc, 0, N_plan_mpc, 1)            = - SUprp_plan_mpc_*MPC_Planner_u_mpc_y_ + zmp_max_Rpy_mpc_;
        const_lb_mpc_.block(2*N_plan_mpc, 0, N_plan_mpc, 1)            = - SUprp_plan_mpc_*MPC_Planner_u_mpc_y_ + zmp_min_Rpy_mpc_;

        ////alpha const
        const_A_mpc_.block( 3*N_plan_mpc, 0, N_plan_mpc, 4*N_plan_mpc) = SUpa_plan_mpc_;
        const_ub_mpc_.block(3*N_plan_mpc, 0, N_plan_mpc, 1)            = - SUpa_plan_mpc_*MPC_Planner_u_mpc_y_ + MatrixXd::Ones(N_plan_mpc, 1) - rf_checker;
        const_lb_mpc_.block(3*N_plan_mpc, 0, N_plan_mpc, 1)            = - SUpa_plan_mpc_*MPC_Planner_u_mpc_y_ + MatrixXd::Zero(N_plan_mpc, 1) + lf_checker;
        */
        ...
        { 
            cout << "sqp iteration: "                             << s    << endl;
            cout << "VHIPM Planner SQ MPC Y direction Not Solved" << endl;
            cout << int(walking_tick_mpc_ - 20)/mpc_synchro_hz    << endl << endl;;
    ...
    MPC_Planner_alpha_mpc_ = 0.0;
    MPC_Planner_lzmp_mpc_  = 0.0;
    MPC_Planner_rzmp_mpc_  = 0.0;
    ...
    e_qcqp_gurobi_graph << setprecision(10)
                        ...
                        << prev_zmp(0,0)             << "," << prev_zmp(1,0)             << "," << MPC_Planner_alpha_mpc_    << ","
                        << zmp_max_Lpy_mpc_(0)       << "," << zmp_min_Lpy_mpc_(0)       << "," << MPC_Planner_lzmp_mpc_     << ","
                        << zmp_max_Rpy_mpc_(0)       << "," << zmp_min_Rpy_mpc_(0)       << "," << MPC_Planner_rzmp_mpc_     << ","
                        << endl;

    e_tmp_graph3 << Pv_y_ref.transpose() << endl;
    e_tmp_graph4 << prev_zmp.row(1)      << endl;
    e_tmp_graph5 << MPC_Planner_u_mpc_y_.segment(1*N_plan_mpc + 0*dsp_length_mpc_tick, 2*dsp_length_mpc_tick).transpose() << endl;
    e_tmp_graph6 << MPC_Planner_u_mpc_y_.segment(1*N_plan_mpc + 2*dsp_length_mpc_tick, 2*dsp_length_mpc_tick).transpose() + 0.01*MatrixXd::Ones(1, 2*dsp_length_mpc_tick) << endl;
    e_tmp_graph7 << MPC_Planner_u_mpc_y_.segment(1*N_plan_mpc + 4*dsp_length_mpc_tick, 2*dsp_length_mpc_tick).transpose() + 0.01*MatrixXd::Ones(1, 2*dsp_length_mpc_tick) << endl;
    e_tmp_graph8 << lf_checker.transpose() << endl;
    e_tmp_graph9 << rf_checker.transpose() << endl;
    e_tmp_graph10 << zmp_max_Lpy_mpc_.transpose() << endl;
    e_tmp_graph11 << zmp_max_Rpy_mpc_.transpose() << endl;
    e_tmp_graph12 << dsp_checker.transpose() << endl;
}
...
void AvatarController::GravityCalculate_MJ()
{
    ...
    if (walking_tick_ < t_start_ + t_rest_init_)
    {
        WBC::SetContact(rd_, 1, 1);
    ...
    else if (walking_tick_ >= t_start_ + t_rest_init_ && walking_tick_ < t_start_ + t_rest_init_ + t_double1_) // 0.03 s
    {
        contact_gain = DyrosMath::cubic(walking_tick_, t_start_ + t_rest_init_, t_start_ + t_rest_init_ + t_double1_, 1.0, 0.0, 0.0, 0.0);
    ...
    else if (walking_tick_ >= t_start_ + t_rest_init_ + t_double1_ && walking_tick_ < t_start_ + t_total_ - t_rest_last_ - t_double2_) // SSP
    {
        if (foot_step_(current_step_num_, 6) == 1) // 왼발 지지
        {
    ...
    else if (walking_tick_ >= t_start_ + t_total_ - t_rest_last_ - t_double2_ && walking_tick_ < t_start_ + t_total_ - t_rest_last_)
    {
        contact_gain = DyrosMath::cubic(walking_tick_, t_start_ + t_total_ - t_rest_last_ - t_double2_, t_start_ + t_total_ - t_rest_last_, 0.0, 1.0, 0.0, 0.0);
        Gravity_SSP_.setZero();
        if (foot_step_(current_step_num_, 6) == 1) // 왼발 지지
        {
            WBC::SetContact(rd_, 1, 1);
    ...
    else if (walking_tick_ >= t_start_ + t_total_ - t_rest_last_ && walking_tick_ < t_start_ + t_total_)
    {
        contact_gain = 1.0;
...
{       
    ...
    t_rest_init_ = 1*0.10 * hz_;
    t_rest_last_ = 1*0.10 * hz_;
    t_double1_ = 1*0.05 * hz_;
    t_double2_ = 1*0.05 * hz_;
    t_total_ = 1.0 * hz_;
...
void AvatarController::hip_compensator()
{
    ...
    if (current_step_num_ == 0)
    {
        if (foot_step_(current_step_num_, 6) == 1) //left support foot
        {
            ...
            {
                left_hip_roll_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_rest_init_ + t_double1_, t_start_ + t_rest_init_ + t_double1_ + temp_time, 0.0, left_hip_roll_first, 0.0, 0.0);
                left_hip_pitch_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_rest_init_ + t_double1_, t_start_ + t_rest_init_ + t_double1_ + temp_time, 0.0, left_hip_pitch_first, 0.0, 0.0);
                left_ank_pitch_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_rest_init_ + t_double1_, t_start_ + t_rest_init_ + t_double1_ + temp_time, 0.0, left_ank_pitch_first, 0.0, 0.0);
            }
            else if (walking_tick_ >= t_start_ + t_total_ - t_rest_last_ - t_double2_ - temp_time)
            {
                left_hip_roll_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_total_ - t_rest_last_ - t_double2_ - temp_time, t_start_ + t_total_ - t_rest_last_, left_hip_roll_first, 0.0, 0.0, 0.0);
                left_hip_pitch_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_total_ - t_rest_last_ - t_double2_ - temp_time, t_start_ + t_total_ - t_rest_last_, left_hip_pitch_first, 0.0, 0.0, 0.0);
                left_ank_pitch_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_total_ - t_rest_last_ - t_double2_ - temp_time, t_start_ + t_total_ - t_rest_last_, left_ank_pitch_first, 0.0, 0.0, 0.0);
            }
            else
            {
        ...
        else if (foot_step_(current_step_num_, 6) == 0) // right support foot
        {
            if (walking_tick_ < t_start_ + t_total_ - t_rest_last_ - t_double2_ - temp_time)
            {
                right_hip_roll_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_rest_init_ + t_double1_, t_start_ + t_rest_init_ + t_double1_ + temp_time, 0.0, right_hip_roll_first, 0.0, 0.0);
                right_hip_pitch_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_rest_init_ + t_double1_, t_start_ + t_rest_init_ + t_double1_ + temp_time, 0.0, right_hip_pitch_first, 0.0, 0.0);
                right_ank_pitch_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_rest_init_ + t_double1_, t_start_ + t_rest_init_ + t_double1_ + temp_time, 0.0, right_ank_pitch_first, 0.0, 0.0);
            }
            else if (walking_tick_ >= t_start_ + t_total_ - t_rest_last_ - t_double2_ - temp_time)
            {
                right_hip_roll_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_total_ - t_rest_last_ - t_double2_ - temp_time, t_start_ + t_total_ - t_rest_last_, right_hip_roll_first, 0.0, 0.0, 0.0);
                right_hip_pitch_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_total_ - t_rest_last_ - t_double2_ - temp_time, t_start_ + t_total_ - t_rest_last_, right_hip_pitch_first, 0.0, 0.0, 0.0);
                right_ank_pitch_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_total_ - t_rest_last_ - t_double2_ - temp_time, t_start_ + t_total_ - t_rest_last_, right_ank_pitch_first, 0.0, 0.0, 0.0);
            }
            else
            {
    ...
    else
    {
        if (foot_step_(current_step_num_, 6) == 1) //left support foot
        {
            if (walking_tick_ < t_start_ + t_total_ - t_rest_last_ - t_double2_ - temp_time)
            {
                ...
                left_ank_pitch_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_rest_init_ + t_double1_, t_start_ + t_rest_init_ + t_double1_ + temp_time, 0, left_ank_pitch, 0.0, 0.0);
            }
            else if (walking_tick_ >= t_start_ + t_total_ - t_rest_last_ - t_double2_ - temp_time)
            {
                ...
                left_ank_pitch_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_total_ - t_rest_last_ - t_double2_ - temp_time, t_start_ + t_total_ - t_rest_last_, left_ank_pitch, 0.0, 0.0, 0.0);
            }
            else
            {
        ...
        else if (foot_step_(current_step_num_, 6) == 0) // right support foot
        {
            if (walking_tick_ < t_start_ + t_total_ - t_rest_last_ - t_double2_ - temp_time)
            {
                ...
                right_ank_pitch_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_rest_init_ + t_double1_, t_start_ + t_rest_init_ + t_double1_ + temp_time, 0, right_ank_pitch, 0.0, 0.0);
            }
            else if (walking_tick_ >= t_start_ + t_total_ - t_rest_last_ - t_double2_ - temp_time)
            {
                ...
                right_ank_pitch_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_total_ - t_rest_last_ - t_double2_ - temp_time, t_start_ + t_total_ - t_rest_last_, right_ank_pitch, 0.0, 0.0, 0.0);
            }
            else
            {
    ...
    for (int i = 0; i < 12; i++)
    {
        if (i < 6)
        {
            ...
            if (foot_step_(current_step_num_, 6) == 0)
            {
                ...
                else if (walking_tick_ >= t_start_ + t_total_ - t_rest_last_ - t_double2_ - compliant_tick && walking_tick_ < t_start_ + t_total_ - t_rest_last_ - t_double2_ + compliant_tick)
                {
                    gain_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_total_ - t_rest_last_ - t_double2_ - compliant_tick, t_start_ + t_total_ - t_rest_last_ - t_double2_ + compliant_tick, default_gain, compliant_gain, 0.0, 0.0);
                }
                else
                {
                    gain_temp = DyrosMath::cubic(walking_tick_, t_start_ + t_total_ - t_rest_last_ - t_double2_ + compliant_tick, t_start_ + t_total_, compliant_gain, default_gain, 0.0, 0.0);
                }
            }
            else
            {
...
void AvatarController::CP_compen_MJ_FT() 
{
    ...
    Eigen::Vector3d del_vrp_desired, vrp_desired;
    del_vrp_desired(0) = 1.4*(dcm_measured_(0) - dcm_desired_(0));
    del_vrp_desired(1) = 1.3*(dcm_measured_(1) - dcm_desired_(1));
    del_vrp_desired(2) = 1.05*(dcm_measured_(2) - dcm_desired_(2));

    vrp_desired(0) = zmp_desired_(0) + del_vrp_desired(0);
    vrp_desired(1) = zmp_desired_(1) + del_vrp_desired(1);
    //vrp_desired(1) = MPC_Planner_lzmp_main_*MPC_Planner_alpha_main_
    //               + MPC_Planner_rzmp_main_*(1 - MPC_Planner_alpha_main_)
    //               + del_vrp_desired(1);
    vrp_desired(2) = zc_mj_          + del_vrp_desired(2);

    lambda_desired = (com_desired_(2) - vrp_desired(2) + GRAVITY*b_*b_)/(com_desired_(2)*b_*b_);
    ZMP_X_DES_CALC = (vrp_desired(0) - (1 - lambda_desired*b_*b_)*com_desired_(0))/(lambda_desired*b_*b_);
    ZMP_Y_DES_CALC = (vrp_desired(1) - (1 - lambda_desired*b_*b_)*com_desired_(1))/(lambda_desired*b_*b_);

    Eigen::Vector3d foot_force;
    foot_force(0) = rd_.link_[COM_id].mass*w_*w_*(com_desired_(0) - vrp_desired(0));
    foot_force(1) = rd_.link_[COM_id].mass*w_*w_*(com_desired_(1) - vrp_desired(1));
    foot_force(2) = rd_.link_[COM_id].mass*w_*w_*(com_desired_(2) - vrp_desired(2)) + rd_.link_[COM_id].mass*GRAVITY;

    double lzmp_calc = MPC_Planner_lzmp_main_ + del_vrp_desired(1)*MPC_Planner_alpha_main_;
    double rzmp_calc = MPC_Planner_rzmp_main_ + del_vrp_desired(1)*(1 - MPC_Planner_alpha_main_);

    e_tmp_graph1 << dcm_desired_(0)         << "," << dcm_desired_(1)        << "," << dcm_desired_(2)         << ","
                 << dcm_measured_(0)        << "," << dcm_measured_(1)       << "," << dcm_measured_(2)        << ","
                 << vrp_desired(0)          << "," << vrp_desired(1)         << "," << vrp_desired(2)          << ","
                 << zmp_desired_(0)         << "," << zmp_desired_(1)        << "," << zc_mj_                  << ","
                 << ZMP_X_DES_CALC          << "," << ZMP_Y_DES_CALC         << "," << zc_mj_                  << ","
                 << MPC_Planner_lzmp_main_  << "," << MPC_Planner_rzmp_main_ << "," << MPC_Planner_alpha_main_ << ","
                 << lzmp_calc               << "," << rzmp_calc              << "," << 0                       << ","
                 << endl;
    ...
    //alpha = MPC_Planner_alpha_main_;
    alpha = DyrosMath::minmax_cut(alpha, 0.0, 1.0); // 왼발 지지때 alpha = 1
    ...
    rfoot_contact_wrench(0) = -(1 - alpha)*foot_force(0) + (-(1 - alpha)*foot_force(0) - rd_.RF_FT(0));
    rfoot_contact_wrench(1) = -(1 - alpha)*foot_force(1) + (-(1 - alpha)*foot_force(1) - rd_.RF_FT(1));
    rfoot_contact_wrench(2) = -(1 - alpha)*foot_force(2) + (-(1 - alpha)*foot_force(2) - rd_.RF_FT(2));
    fl = -alpha * (rd_.link_[COM_id].mass + real_robot_mass_offset_) * dcm_mpc_i_z_acc;
    lfoot_contact_wrench(0) =     - alpha *foot_force(0) + (    - alpha *foot_force(0) - rd_.LF_FT(0));
    lfoot_contact_wrench(1) =     - alpha *foot_force(1) + (    - alpha *foot_force(1) - rd_.LF_FT(1));
    lfoot_contact_wrench(2) =     - alpha *foot_force(2) + (    - alpha *foot_force(2) - rd_.LF_FT(2));
    ...
    rfoot_contact_wrench(3) = Tau_R_x;
    Tau_L_x = (alpha)*Tau_all_x;
    lfoot_contact_wrench(3) = Tau_L_x;

    Tau_L_y = -alpha * Tau_all_y;
    lfoot_contact_wrench(4) = Tau_L_y;
    Tau_R_y = -(1 - alpha) * Tau_all_y;
    rfoot_contact_wrench(4) = Tau_R_y;

    contact_wrench_.segment(0,6) = -lfoot_contact_wrench;
    contact_wrench_.segment(6,6) = -rfoot_contact_wrench;
    ...
    if(walking_tick_ < 4.0*hz_) { F_T_L_x_input_dot = -0.04 * (Tau_L_x - l_ft_LPF(3)) - 40.0 * F_T_L_x_input; }
...
Eigen::VectorQd AvatarController::MitWholebodyInverseDynamicsController(const Eigen::VectorQd &torque_prev, const Eigen::VectorVQd &qddot_cmd, const Eigen::Vector12d &f_c_cmd)
{
    ...
    if (is_wbid_init_ == true)
    {
        ...
        J_rfoot_.setZero();     J_rfoot_ = rd_.link_[Left_Foot].Jac();
        J_rfoot_pre_.setZero(); J_rfoot_pre_ = rd_.link_[Left_Foot].Jac();
    ...
    if(is_dsp_fast_)    
    {
        //W_c_lfoot = W_c_lfoot_wbid;
        //W_c_rfoot = W_c_rfoot_wbid;
        W_c_lfoot = 1.0;
        W_c_rfoot = 1.0;
    }
